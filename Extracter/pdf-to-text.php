    ...
    if (curl_errno($curl) == 0)
    {
        ...
        if ($status_code == 200)
        {
            ...
            if (!isset($json["error"]) || $json["error"] == false)
            {
                ...
                //  My api Key = adeshinadanielayobami@gmail.com_d5456cfd32ae0e82774566c9fe11aac22f87af9b9ab8223c4757d3b9ddceffeee4dab6f0
                // My api Key = adedoyintioluwanimi@gmail.com_4452d65453246f5be08db01707f3444f1b2c79430a97cf14c5503d6c209d0c0dc8c9b1f8
                $content = file_get_contents(trim($resultFileUrl));
                session_start();
                echo $_SESSION['content'] = $content;
                header("Location:../");
            }
            else
            {
